...
function Strategy(options, verify) {
  ...
  if (!options.tokenURL) { throw new TypeError('TmoidStrategy requires a token endpoint option'); }
  ...
  var tokenhref = url.parse(options.tokenURL);
  ...
  this._tokenHostname = tokenhref.host;
  this._tokenPath = tokenhref.path;
